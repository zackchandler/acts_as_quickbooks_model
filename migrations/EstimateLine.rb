...
t.decimal :markup_rate, :precision => 9, :scale => 2
t.decimal :markup_rate_percent, :precision => 9, :scale => 2
...
add_column :table_name, :markup_rate, :decimal, :precision => 9, :scale => 2
add_column :table_name, :markup_rate_percent, :decimal, :precision => 9, :scale => 2
...
remove_column :table_name, :markup_rate
remove_column :table_name, :markup_rate_percent
