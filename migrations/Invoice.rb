...
add_column :table_name, :is_finance_charge, :boolean
...
add_column :table_name, :applied_amount, :decimal, :precision => 9, :scale => 2
add_column :table_name, :balance_remaining, :decimal, :precision => 9, :scale => 2
add_column :table_name, :memo, :string, :limit => 4095
add_column :table_name, :is_paid, :boolean
...
add_column :table_name, :suggested_discount_amount, :decimal, :precision => 9, :scale => 2
add_column :table_name, :suggested_discount_date, :datetime
...
remove_column :table_name, :is_finance_charge
...
remove_column :table_name, :applied_amount
remove_column :table_name, :balance_remaining
remove_column :table_name, :memo
remove_column :table_name, :is_paid
...
remove_column :table_name, :suggested_discount_amount
remove_column :table_name, :suggested_discount_date
